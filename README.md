...
* **oimSimlulator** : Main class holding evertyhing together and producing final results :plots, tables...
...
>* oimSimlulator: Simulated data and chi2 computation (no filtering no flagging yet)    
