...
ud2 = oim.oimUD(x=0, y=5, d=1.5, f=oim.oimInterpWl(
    wl=[3e-6, 4e-6], value=[0, 1]))
ud3 = oim.oimUD(x=-5, y=2, d=0.5,
                f=oim.oimInterpWl(wl=[3e-6, 4e-6], value=[0.1, 1]))
eg = oim.oimEGauss(fwhm=1, elong=1.5, pa=oim.oimInterpWl(
    [3e-6, 4e-6], [20, 60]), f=oim.oimInterpWl([3e-6, 4e-6], [1, 0.1]))
er = oim.oimERing(din=8, dout=oim.oimInterpWl(
    [3e-6, 4e-6], [15, 20]), elong=2, pa=0)
