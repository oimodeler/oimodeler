...
pathData=os.path.join(path,os.pardir,"examples","testData","RealData","AMBER","AlphaCol")
...
m.showModel(dim,0.05,wl=wl,legend=True,normalize=True,fromFT=False,normPow=0.5,colorbar=False,cmap="hot")
...
title="$\\alpha$ Col AMBER data + Kinematic disk model: chi$^2_r$= {:.1f}".format(sim.chi2r)
fig.suptitle(title)
