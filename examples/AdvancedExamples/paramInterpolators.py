...
plt.savefig(os.path.join(path, os.pardir, "images","interp2.png"))
...
plt.savefig(os.path.join(path, os.pardir, "images","interp3.png"))
...
plt.savefig(os.path.join(path, os.pardir, "images","interp4.png"))
#%%
