...
img=model.getImage(256,0.06,toFits=True,fromFT=True,wl=np.linspace(3,4,num=50)*1e-6)
imgfname=os.path.join(path,os.pardir,"examples","testData","IMAGES","skwDisk.fits")
