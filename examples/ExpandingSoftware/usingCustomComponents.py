...
fastRot=oimFastRotator(dpole=5,dim=128,incl=-70,rot=0.99,Tpole=20000,beta=0.25,f=0.9,pa=30,x=10,y=5)
spiral=oimSpiral(dim=128,fwhm=2.5,P=0.1,width=0.1,pa=30,elong=2,x=10,y=-5,f=0.2)
gauss=oim.oimGauss(y=0,x=-5,fwhm=oim.oimInterp("wl",wl=[1e-6,2e-6],values=[0.5,4]),
                           f=oim.oimInterp("wl",wl=[1e-6,2e-6],values=[0,0.1]))
box=oimBox(dx=2,dy=oim.oimInterp("wl",wl=[1e-6,2e-6],values=[0.5,2]),f=0.1,pa=20)
...
fig.savefig(os.path.join(path,os.pardir,"images","usingCustomComponents.png"))
