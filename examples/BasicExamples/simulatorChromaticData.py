...
pathData=os.path.join(path,os.pardir,"examples","testData","HD50138_MATISSE")
...
ud=oim.oimERing(din=18,dout=25,elong=1.4,PA=76,f=oim.oimInterpWl(wl=[3e-6,5e-6],value=[0.5,1]))
pt=oim.oimPt(f=oim.oimInterpWl(wl=[3e-6,5e-6],value=[0.5,0.0]))
