...
# NOTE: Create a new fitter with 32 walkers and the list of oifits files and the model
...
# NOTE: Printing the initial values of the walkers
pprint(
    f"Initial values of the free parameters for the {fit.params['nwalkers']} walkers"
)
