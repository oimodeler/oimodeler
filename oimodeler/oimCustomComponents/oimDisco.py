...
class oimDisco(oimComponentImage):
    ...
    def __init__(self, **kwargs):
        ...
        text = (
            "The DISCO model was created by A. Domiciano de Souza "
    ...
    def _internalImage(self):
        star = {
            "model": "BBsphere",
            "Req_sun": self.params["Rstar"].value
            * self.params["Rstar"].unit.to(u.Rsun),
            "Teq": self.params["Teff"].value,  # K
            "Mstar_sun": self.params["Mstar"].value
            * self.params["Mstar"].unit.to(u.Msun),
        }
